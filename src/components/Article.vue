	...
	<div class="center">
		<section id="content">
			<article class="article-item article-detail" v-if="article">
					...
					<!-- para limpiar lo flotado -->
					<div class="clearfix"></div>

					<router-link :to="'/editar/'+article._id" class="btn btn-warning">Editar</router-link>
					<a v-on:click="deleteArticle(article._id)" class="btn btn-danger">Eliminar</a>
...
swal({
					title:	'Estás seguro?',
					text:	'El artículo será eliminado permanentemente',
					icon: 'warning',
					buttons: true,
					dangerMode: true
					}).then(willDelete => {
						...
						swal('El artículo ha sido elimiinado', 'success');
					this.$router.push('/blog');
					})
						} else {
